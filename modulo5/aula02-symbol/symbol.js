...
// console.log('gettint normal Objects', user[Symbol('userName')]);
...
//debugando tem acesso ao valor do user. 
//valor não é privado, apenas uma pouco mais difícil de acessar
// console.log('=> => symbols => => ', Object.getOwnPropertySymbols(user)[0]);
assert.deepStrictEqual(Object.getOwnPropertySymbols(user)[0], uniqueKey)

//byPass - má prática (nem tem no cadebase do node)
...
//well know Symbols
const obj ={
  //iterators - esse iterator é o que o * faz por baixo dos panos
  [Symbol.iterator]: () => ({
    items: ['c','b','a'],
    next() {
      return {
...
assert.deepStrictEqual(Object.prototype.toString.call(myDate), '[object má WHAT??]')
